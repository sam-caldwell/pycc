...
void GeometryVisitor::bump() { ++nodes; maxDepth = std::max(maxDepth, depth); }
...
void GeometryVisitor::visit(const Literal<long long, NodeKind::IntLiteral>& intLiteral) { (void)intLiteral; bump(); }
void GeometryVisitor::visit(const Literal<bool, NodeKind::BoolLiteral>& boolLiteral) { (void)boolLiteral; bump(); }
void GeometryVisitor::visit(const Literal<double, NodeKind::FloatLiteral>& floatLiteral) { (void)floatLiteral; bump(); }
void GeometryVisitor::visit(const Literal<std::string, NodeKind::StringLiteral>& stringLiteral) { (void)stringLiteral; bump(); }
void GeometryVisitor::visit(const NoneLiteral& noneLiteral) { (void)noneLiteral; bump(); }
...
void GeometryVisitor::visit(const Name& name) { (void)name; bump(); }
