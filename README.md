...
- AOT-only imports/lifecycle: Module initialization is generated by Codegen as LLVM IR (global constructors). The runtime
  does not implement an import system or module registry and never dynamically loads Python modules.
